...
$webFiles = @(
  'index.html','worklog.html','staff.html','dashboard.html','data-edit.html','master.html','targets.html',
  'styles.css','staff.css','dashboard.css','data-edit.css','master.css','targets.css',
  'app.js','staff.js','dashboard.js','backend.js','config.js','data-edit.js','master.js','targets.js'
)
if ($Only) {
